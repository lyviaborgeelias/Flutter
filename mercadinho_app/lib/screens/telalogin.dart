...
class _TelaLoginState extends State<TelaLogin> {
  ...
  void fazerLogin() async {
    final respostaServidor = await http.get(Uri.parse("https://api-mercadinho-gq9r.onrender.com/usuarios"));
    if(respostaServidor.statusCode == 200){
      ...
      if(mounted){
       ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Usuário ou senha inválidos!")));
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Center(child: Column(
        ...
        children: [
          InputLogin(fofoqueira: emailDigitado, placeholder: "Digite seu email"),
          InputLogin(fofoqueira: senhaDigitada, placeholder: "Digite seu email"),
